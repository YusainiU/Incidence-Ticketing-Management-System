...
<div>
    ...
    <div class="{{ $paragraph_1 }} mt-10">
        This Application is designed with a small and medium-size company in mind that doesn't need a complex
        or complicated incidence/case management system. It is open source, hence no enterpise style licensing
        is required to run it. Built using a standard Laravel/Livewire framework and MySQL.
    </div>        
    <div class="{{ $paragraph_1 }} mt-10">
        It is a very simple and intuitive. The application focuses on the whole lifecycle of the incident/case management process, from the point when the
            ...
            <ul class="{{ $list }} mt-4">
                ...
                <li class="{{ $list_item }}">
                    <div class="{{ $listContainer }}">
                        ...
                        <div class="{{ $listSmallInfo }}">
                            <hr class="{{ $listLine }}" />
                            .. it provides the ability for admin with specific privileges to enable
                            and disable customer portal.
                        </div>
                    </div>
                </li>                
            ...
            <ul class="{{ $list }} mt-4">
                ...
                <li class="{{ $list_item }}">
                    <div class="{{ $listContainer }}">
                        <div class="{{ $listArrow }}">
                            {!! $arrowRight !!}
                            <span>The Ability to import and export data</span>
                        </div>
                        <div class="{{ $listSmallInfo }}">
                            <hr class="{{ $listLine }}" />
