...
<body class="{{ $body_bg_class }}">
    <div>
        ...
        <section class="{{ $section }}" id="contact">
            <div class="{{ $view }}">
                <h1 class="text-gray-500 dark:text-gray-400 text-center text-4xl font-extrabold">
                    License
                </h1>
            </div>
            ...
            <div class="{{ $view }}">
                ...
                <p class="{{ $para }} pb-10 w-full text-center flex justify-center">
                    <a href="http://www.apache.org/licenses/LICENSE-2.0" class="{{ $view_link }}" target="_blank">
                        Apache License <br />
                ...
                <div class="{{ $whiteBox }}">
                    ...
                    <p class="{{ $para }}">
                        ...
                        Source
                        form, including but not limited to compiled object code, generated documentation, and
                        conversions to
                        other media types.
                    </p>
                    ...
                    <p class="{{ $para }}">
                        ...
                        Derivative
                        Works shall not include works that remain separable from, or merely link (or bind by name) to
                        the
                    ...
                    <p class="{{ $para }}">
                        ...
                        systems,
                        and
                        issue tracking systems that are managed by, or on behalf of, the Licensor for the purpose of
                        discussing
                    ...
                    <p class="{{ $para }}">
                        ...
                        thereof
                        in
                        any medium, with or without modifications, and in Source or Object form, provided that You meet
                        the
                    ...
                    <ul class="">
                        ...
                        <li class="{{ $list }}">
                            ...
                            NOTICE
                            file, excluding those notices that do not pertain to any part of the Derivative Works, in at
                            least
                            one
                            of the following places: within a NOTICE text file distributed as part of the Derivative
                            Works;
                            within
                            the Source form or documentation, if provided along with the Derivative Works; or, within a
                            display
                            generated by the Derivative Works, if and wherever such third-party notices normally appear.
                            The
                    ...
                    <p class="{{ $para }}">
                        ...
                        are
                        solely responsible for determining the appropriateness of using or redistributing the Work and
                        assume
                    ...
                    <p class="{{ $para }}">
                        ...
                        indemnity,
                        or
                        other liability obligations and/or rights consistent with this License. However, in accepting
                        such
                        ...
                        harmless
                        for
                        any liability incurred by, or claims asserted against, such Contributor by reason of your
                        accepting
                        any
